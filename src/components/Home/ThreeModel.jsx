...
const ThreeModel = () => {
  ...
  return (
    <div className="h-[80%] w-[80%] relative">
      ...
      {/* Background Images */}
      <img src={Frame} className="absolute top-0 -z-10" alt="" />
      <img src={Frame16} className="absolute -bottom-36  -left-7" alt="" />
      <img src={Frame39} className="absolute -bottom-44  -right-32" alt="" />

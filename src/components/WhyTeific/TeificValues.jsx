...
const TeificValues = () => {
  return (
    ...
    <h2 className='my-10 lg:my-0 text-center lg:text-left text-3xl font-bold px-24'>Teific Technology <span className='text-[#FBC93E]'>Values</span></h2>
    <div className='px-10 lg:px-36 flex w-full h-full  flex-col lg:flex-row-reverse gap-10'>
        ...
        <div className='w-full lg:w-1/2 h-full flex flex-col justify-evenly lg:px-12 gap-10 lg:gap-0 ' >

...
const ChooseTeific = () => {
  return (
    <div className='w-full lg:h-screen py-10 bg-[#1D1D1F]'>
        <h2 className='my-10 lg:my-0 text-3xl font-bold px-24 text-center lg:text-left'>Here's why you should choose <span className='text-[#FBC93E]'>Teific</span></h2>
        <div className='px-10  lg:px-36 flex gap-10 lg:gap-16  lg:flex-row flex-col w-full h-full justify-center items-center'>
            <div className='  lg:w-1/2 h-full gap-10 lg:gap-2 flex flex-col items-center  justify-evenly'> 
            ...
            <div className='lg:w-1/2 h-full flex flex-col justify-evenly  gap-10 lg:gap-0' >
